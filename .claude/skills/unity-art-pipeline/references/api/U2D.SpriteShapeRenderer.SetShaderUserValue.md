<!-- source: /home/reza/projects/game/docs/UnityDocumentation/Documentation/en/ScriptReference/U2D.SpriteShapeRenderer.SetShaderUserValue.html
 ...
 **Note**: The value is not serialized, so it is not saved to the asset and resets when the object is reloaded.
 ...
 Additional resources: SpriteShapeRenderer.GetShaderUserValue.
...
{
    public Color color = Color.white;    private SpriteShapeRenderer m_Renderer;    void Start()
    {
