<!-- source: /home/reza/projects/game/docs/UnityDocumentation/Documentation/en/ScriptReference/TerrainData.html
...
| heightmapResolution | The size of the heightmap in texels for both the width and height. When setting the heightmap resolution, Unity clamps the value to one of 33, 65, 129, 257, 513, 1025, 2049, or 4097. |
...
| size | The total size in world units of the terrain: width, height, and length. |
...
| treePrototypes | The list of TreePrototypes available in the inspector. |
...
| GetHeight | Calculates the height in world space units of a point on the heightmap. x and y are pixel coordinates in the heightmap, and the returned value does not take into account the heightmap's position. |
...
| GetInterpolatedNormal | Get an interpolated normal vector at a given location on the heightmap. |
