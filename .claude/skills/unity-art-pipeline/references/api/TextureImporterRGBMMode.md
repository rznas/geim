<!-- source: /home/reza/projects/game/docs/UnityDocumentation/Documentation/en/ScriptReference/TextureImporterRGBMMode.html
...
| --- | --- |
| Auto | Do RGBM encoding when source data is HDR in TextureImporter. |
| On | Do RGBM encoding in TextureImporter. |
| Off | Do not perform RGBM encoding in TextureImporter. |
| Encoded | Source texture is already RGBM encoded in TextureImporter. |
