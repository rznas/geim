<!-- source: /home/reza/projects/game/docs/UnityDocumentation/Documentation/en/ScriptReference/AssetImporters.AssetImporterEditor.ApplyRevertButtonContainer.html
     Unity 6 (6000.x) — converted by unity_html_to_md.py.
     Doc-sourced; not compile-tested in this environment. -->

### Description

Adds the 'Apply' and 'Revert' buttons to the Editor UI. Use this VisualElement in a ScriptedImporterEditor when AssetImporterEditor.needsApplyRevert is enabled. This is the UIToolkit equivalent to AssetImporterEditor.ApplyRevertGUI.

```csharp
using UnityEngine;
using UnityEditor;
using UnityEditor.AssetImporters;
using UnityEngine.UIElements;public class ExampleScript : ScriptedImporterEditor
{
    public override VisualElement CreateInspectorGUI()
    {
        var root = new VisualElement();        var applyRevertContainer = new ApplyRevertButtonContainer(this);
        root.Add(applyRevertContainer);
...
| --- | --- |
| AssetImporterEditor.ApplyRevertButtonContainer | Constructs a ApplyRevertButtonContainer. |
