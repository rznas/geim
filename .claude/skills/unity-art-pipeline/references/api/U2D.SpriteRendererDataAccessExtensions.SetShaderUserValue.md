<!-- source: /home/reza/projects/game/docs/UnityDocumentation/Documentation/en/ScriptReference/U2D.SpriteRendererDataAccessExtensions.SetShaderUserValue.html
 ...
 **Note**: The value is not serialized, so it is not saved to the asset and resets when the object is reloaded.
 ...
 Additional resources: SpriteRenderer.GetShaderUserValue.
...
{
    public Color color = Color.white;    private SpriteRenderer m_Renderer;    void Start()
    {
