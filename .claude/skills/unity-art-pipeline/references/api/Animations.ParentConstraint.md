<!-- source: /home/reza/projects/game/docs/UnityDocumentation/Documentation/en/ScriptReference/Animations.ParentConstraint.html
...
```csharp
// This example uses a ParentConstraint to constrain a GameObject based on the position and rotation of two sources. 
// The first source has a greater influence than the second source based on their assigned weight.

using UnityEngine;
using UnityEngine.Animations;

public class ParentConstraintExample : MonoBehaviour
{
    ...
    void Start()
    {
        m_ParentConstraint = gameObject.AddComponent<ParentConstraint>();
        ...
        m_ParentConstraint.AddSource(source1);
        m_ParentConstraint.AddSource(source2);
