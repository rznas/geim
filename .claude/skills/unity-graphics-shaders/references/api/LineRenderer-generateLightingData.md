<!-- source: /home/reza/projects/game/docs/UnityDocumentation/Documentation/en/ScriptReference/LineRenderer-generateLightingData.html
...
public class ExampleClass : MonoBehaviour
{
    private LineRenderer lr;    void Start()
    {
        ...
        lr.generateLightingData = true;        // Set some positions
