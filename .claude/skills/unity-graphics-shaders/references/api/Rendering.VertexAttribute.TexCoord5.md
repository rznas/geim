<!-- source: /home/reza/projects/game/docs/UnityDocumentation/Documentation/en/ScriptReference/Rendering.VertexAttribute.TexCoord5.html
     Unity 6 (6000.x) — converted by unity_html_to_md.py.
     Doc-sourced; not compile-tested in this environment. -->

### Description

The sixth set of UV coordinates of the vertex.
...
This attribute corresponds to the `TEXCOORD5` semantic in the HLSL shading language.
