<!-- source: /home/reza/projects/game/docs/UnityDocumentation/Documentation/en/ScriptReference/Mesh-uv3.html
...
```csharp
// Generate planar uv coordinates for the third uv setusing UnityEngine;public class ExampleClass : MonoBehaviour
{
    void Start()
    {
