<!-- source: /home/reza/projects/game/docs/UnityDocumentation/Documentation/en/ScriptReference/Mesh-uv6.html
...
This channel is also commonly called "UV5". It maps to the shader semantic `TEXCOORD5`. When you call Mesh.HasVertexAttribute, this channel corresponds to VertexAttribute.TexCoord5.
...
```csharp
// Generate planar uv coordinates for the sixth uv setusing UnityEngine;public class ExampleClass : MonoBehaviour
{
    void Start()
    {
