<!-- source: /home/reza/projects/game/docs/UnityDocumentation/Documentation/en/Manual/batch-renderer-group-how.html
...
- Render DOTS [Entities](https://docs.unity3d.com/Packages/com.unity.entities@latest). For more information how Entities uses BRG, refer to Entities Graphics Performance.
...
Unity doesn’t perform frustum culling or occlusion culling of instances you draw with the `BatchRendererGroup` API. You must provide your own culling code.
