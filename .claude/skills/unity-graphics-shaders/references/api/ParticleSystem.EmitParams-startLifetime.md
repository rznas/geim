<!-- source: /home/reza/projects/game/docs/UnityDocumentation/Documentation/en/ScriptReference/ParticleSystem.EmitParams-startLifetime.html
...
Additional resources: ParticleSystem.Particle.startLifetime.

```csharp
using UnityEngine;// In this example we have a Particle System emitting aligned particles; we then emit and override the lifetime every 2 seconds.
public class ExampleClass : MonoBehaviour
{
    private ParticleSystem system;    void Start()
    {
        ...
        mainModule.startLifetimeMultiplier = 0.1f;        // Every 2 seconds we will emit.
