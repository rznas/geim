<!-- source: /home/reza/projects/game/docs/UnityDocumentation/Documentation/en/ScriptReference/ParticleSystem.MainModule-startRotationMultiplier.html
...
public class ExampleClass : MonoBehaviour
{
    ...
    {
        ps = GetComponent<ParticleSystem>();        var psr = GetComponent<ParticleSystemRenderer>();
