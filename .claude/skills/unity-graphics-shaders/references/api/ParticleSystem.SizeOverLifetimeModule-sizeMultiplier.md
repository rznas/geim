<!-- source: /home/reza/projects/game/docs/UnityDocumentation/Documentation/en/ScriptReference/ParticleSystem.SizeOverLifetimeModule-sizeMultiplier.html
     Unity 6 (6000.x) — converted by unity_html_to_md.py.
     Doc-sourced; not compile-tested in this environment. -->

### Description

A multiplier for ParticleSystem.SizeOverLifetimeModule.size.
...
public class ExampleClass : MonoBehaviour
{
    ...
    public float hSliderValue = 1.0f;    void Start()
    {
        ...
        sizeOverLifetime.sizeMultiplier = 1.0f;        var psr = GetComponent<ParticleSystemRenderer>();
