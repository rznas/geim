<!-- source: /home/reza/projects/game/docs/UnityDocumentation/Documentation/en/ScriptReference/ParticleSystem.RotationBySpeedModule-y.html
...
public class ExampleClass : MonoBehaviour
{
    ...
    public float hSliderValue = 1.0f;    void Start()
    {
        ...
        curve.AddKey(1.0f, 1.0f);        rotationBySpeed.x = 0.0f;
