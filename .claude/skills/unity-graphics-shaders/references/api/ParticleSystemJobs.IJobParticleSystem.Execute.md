<!-- source: /home/reza/projects/game/docs/UnityDocumentation/Documentation/en/ScriptReference/ParticleSystemJobs.IJobParticleSystem.Execute.html
...
using UnityEngine.ParticleSystemJobs;public class ParticleJob : MonoBehaviour
{
    ...
    }    struct UpdateParticlesJob : IJobParticleSystem
    {
        ...
        public float inverseEffectRange;        public void Execute(ParticleSystemJobData particles)
        {
            ...
            var velocitiesZ = particles.velocities.z;            var colors = particles.startColors;            var randomSeeds = particles.randomSeeds;            for (int i = 0; i < particles.count; i++)
            {
