<!-- source: /home/reza/projects/game/docs/UnityDocumentation/Documentation/en/ScriptReference/ParticleSystem.RotationOverLifetimeModule-enabled.html
...
Additional resources: ParticleSystem.rotationOverLifetime.
...
public class ExampleClass : MonoBehaviour
{
    ...
    public float hSliderValue = 1.0f;    void Start()
    {
        ...
        rotationOverLifetime.enabled = true;        AnimationCurve curve = new AnimationCurve();
        curve.AddKey(0.0f, 0.0f);
        curve.AddKey(1.0f, 1.0f);        rotationOverLifetime.z = new ParticleSystem.MinMaxCurve(Mathf.PI * 2.0f, curve);        var psr = GetComponent<ParticleSystemRenderer>();
