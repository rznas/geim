<!-- source: /home/reza/projects/game/docs/UnityDocumentation/Documentation/en/ScriptReference/Mesh-uv5.html
...
This channel is also commonly called "UV4". It maps to the shader semantic `TEXCOORD4`. When you call Mesh.HasVertexAttribute, this channel corresponds to VertexAttribute.TexCoord4.
...
```csharp
// Generate planar uv coordinates for the fifth uv setusing UnityEngine;public class ExampleClass : MonoBehaviour
{
    void Start()
    {
