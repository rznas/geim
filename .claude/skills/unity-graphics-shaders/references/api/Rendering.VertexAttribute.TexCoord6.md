<!-- source: /home/reza/projects/game/docs/UnityDocumentation/Documentation/en/ScriptReference/Rendering.VertexAttribute.TexCoord6.html
     Unity 6 (6000.x) — converted by unity_html_to_md.py.
     Doc-sourced; not compile-tested in this environment. -->

### Description

The seventh set of UV coordinates of the vertex.

This attribute is optional. You can use it to describe additional texture coordinates.
...
This attribute corresponds to the `TEXCOORD6` semantic in the HLSL shading language.
