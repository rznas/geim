<!-- source: /home/reza/projects/game/docs/UnityDocumentation/Documentation/en/ScriptReference/Mesh-boneWeights.html
...
```csharp
using UnityEngine;public class SkinnedMeshExample : MonoBehaviour{
    void Start(){
        ...
        clip.legacy = true;
        clip.wrapMode = WrapMode.Loop;        // Add and play the clip
