<!-- source: /home/reza/projects/game/docs/UnityDocumentation/Documentation/en/ScriptReference/ParticleSystem.RotationOverLifetimeModule-zMultiplier.html
...
public class ExampleClass : MonoBehaviour
{
    ...
    public float hSliderValue = 1.0f;    void Start()
    {
        ...
        curve.AddKey(1.0f, 1.0f);        rotationOverLifetime.zMultiplier = (Mathf.PI * 2.0f);        var psr = GetComponent<ParticleSystemRenderer>();
