<!-- source: /home/reza/projects/game/docs/UnityDocumentation/Documentation/en/ScriptReference/Mesh-uv4.html
...
This channel is also commonly called "UV3". It maps to the shader semantic `TEXCOORD3`. When you call Mesh.HasVertexAttribute, this channel corresponds to VertexAttribute.TexCoord3.
...
```csharp
// Generate planar uv coordinates for the fourth uv setusing UnityEngine;public class ExampleClass : MonoBehaviour
{
    void Start()
    {
