<!-- source: /home/reza/projects/game/docs/UnityDocumentation/Documentation/en/ScriptReference/Mesh-uv2.html
...
This channel is also commonly called "UV1". It maps to the shader semantic `TEXCOORD1`. When you call Mesh.HasVertexAttribute, this channel corresponds to VertexAttribute.TexCoord1.

Unity can use this channel to store UVs for baked lightmaps, or input UVs that it uses to calculte final UVs for real-time lightmaps. For more information, see Lightmap UVs.
...
```csharp
// Generate planar uv coordinates for the second uv setusing UnityEngine;public class ExampleClass : MonoBehaviour
{
    void Start()
    {
