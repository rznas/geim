<!-- source: /home/reza/projects/game/docs/UnityDocumentation/Documentation/en/ScriptReference/Rendering.RayTracingShader.DisableKeyword.html
...
| --- | --- |
| keyword | The local keyword to disable. |

### Description

Disables a local shader keyword for this ray tracing shader.
