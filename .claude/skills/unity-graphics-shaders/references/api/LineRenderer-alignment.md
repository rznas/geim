<!-- source: /home/reza/projects/game/docs/UnityDocumentation/Documentation/en/ScriptReference/LineRenderer-alignment.html
...
public class ExampleClass : MonoBehaviour
{
    private LineRenderer lr;    void Start()
    {
        ...
        lr.SetPositions(positions);        // Set to face its Transform Component
