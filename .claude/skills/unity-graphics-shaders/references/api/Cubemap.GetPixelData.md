<!-- source: /home/reza/projects/game/docs/UnityDocumentation/Documentation/en/ScriptReference/Cubemap.GetPixelData.html
...
Additional resources: Apply, SetPixels, GetPixelData.
...
using UnityEngine;public class ExampleScript : MonoBehaviour
{
    ...
    {        // Create a cubemap texture
        var m_Cubemap = new Cubemap(16, TextureFormat.RGBA32, true);        // Use GetPixelData to get an array that points to mipmap level 1
        var mip1Face4 = m_Cubemap.GetPixelData<Color32>(1, CubemapFace.PositiveZ);        // Fill pixels in mipmap level 1 with white
        for (int i = 0; i < mip1Face4.Length; i++)
        {
            mip1Face4[i] = new Color32(255, 255, 255, 255);
