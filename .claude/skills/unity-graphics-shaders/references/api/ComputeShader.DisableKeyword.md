<!-- source: /home/reza/projects/game/docs/UnityDocumentation/Documentation/en/ScriptReference/ComputeShader.DisableKeyword.html
...
| --- | --- |
| keyword | The LocalKeyword to disable. |
| keyword | The name of the LocalKeyword to disable. |
...
```csharp
using UnityEngine;
using UnityEngine.Rendering;public class ComputeKeywordExample : MonoBehaviour
{
...
Additional resources: Shader variants and keywords, LocalKeyword, GlobalKeyword, EnableKeyword, SetKeyword, keywordSpace, IsKeywordEnabled, enabledKeywords, shaderKeywords.
