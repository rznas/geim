<!-- source: /home/reza/projects/game/docs/UnityDocumentation/Documentation/en/ScriptReference/ParticleSystem.EmitParams-startSize3D.html
...
Additional resources: ParticleSystem.Particle.startSize3D.
...
public class ExampleClass : MonoBehaviour
{
    private ParticleSystem system;    void Start()
    {
        ...
        mainModule.startSize3D = true;        // Every 2 seconds we will emit.
