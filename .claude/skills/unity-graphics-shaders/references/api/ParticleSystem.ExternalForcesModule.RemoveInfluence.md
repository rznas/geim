<!-- source: /home/reza/projects/game/docs/UnityDocumentation/Documentation/en/ScriptReference/ParticleSystem.ExternalForcesModule.RemoveInfluence.html
...
using UnityEngine;public class Example : MonoBehaviour
{
    ...
    }    void OnGUI()
    {
        ...
        {
            var influence = externalForcesModule.GetInfluence(i);            GUILayout.BeginHorizontal();
