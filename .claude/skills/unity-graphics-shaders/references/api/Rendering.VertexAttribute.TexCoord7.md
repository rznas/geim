<!-- source: /home/reza/projects/game/docs/UnityDocumentation/Documentation/en/ScriptReference/Rendering.VertexAttribute.TexCoord7.html
     Unity 6 (6000.x) — converted by unity_html_to_md.py.
     Doc-sourced; not compile-tested in this environment. -->

### Description

The eighth set of UV coordinates of the vertex.
...
This attribute corresponds to the `TEXCOORD7` semantic in the HLSL shading language.
