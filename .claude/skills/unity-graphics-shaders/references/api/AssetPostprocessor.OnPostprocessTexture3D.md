<!-- source: /home/reza/projects/game/docs/UnityDocumentation/Documentation/en/ScriptReference/AssetPostprocessor.OnPostprocessTexture3D.html
...
using UnityEditor;
using UnityEngine;
using System.Collections;// Postprocesses all 3D textures that are placed in a folder
...
public class InvertColor : AssetPostprocessor
{
    ...
    public override uint GetVersion() { return k_Version; }    void OnPostprocessTexture3D(Texture3D texture)
    {
