<!-- source: /home/reza/projects/game/docs/UnityDocumentation/Documentation/en/ScriptReference/ParticleSystemJobs.IJobParticleSystemParallelForBatch.Execute.html
...
using UnityEngine.ParticleSystemJobs;public class ParticleJob : MonoBehaviour
{
    ...
    }    struct UpdateParticlesJob : IJobParticleSystemParallelForBatch
    {
        ...
        public float inverseEffectRange;        public void Execute(ParticleSystemJobData particles, int startIndex, int count)
        {
            ...
            var velocitiesZ = particles.velocities.z;            var colors = particles.startColors;            var randomSeeds = particles.randomSeeds;            int endIndex = startIndex + count;
