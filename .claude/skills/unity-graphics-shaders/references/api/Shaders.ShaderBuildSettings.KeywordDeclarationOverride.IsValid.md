<!-- source: /home/reza/projects/game/docs/UnityDocumentation/Documentation/en/ScriptReference/Shaders.ShaderBuildSettings.KeywordDeclarationOverride.IsValid.html
...
**bool** True if the override data is valid.

### Description

Validates the keyword declaration override data.

Checks the override data for potential invalid or duplicate keywords. Returns `false` and an error message if there are any validation errors.
