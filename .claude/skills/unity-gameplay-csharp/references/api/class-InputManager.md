<!-- source: /home/reza/projects/game/docs/UnityDocumentation/Documentation/en/Manual/class-InputManager.html
...
You can use input from the **Horizontal** and **Vertical** axes and the `transform.Translate` method to move a **GameObject** in XZ space (forward, back, left, or right). Add the following code to the `update()` method on a script attached to the GameObject you want to move:
