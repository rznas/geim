<!-- source: /home/reza/projects/game/docs/UnityDocumentation/Documentation/en/ScriptReference/Events.UnityEvent_4.html
...
{
    UnityEvent<int, int, int, int> m_MyEvent;    void Start()
    {
        if (m_MyEvent == null)
            m_MyEvent = new UnityEvent<int, int, int, int>();        m_MyEvent.AddListener(DoSomething);
    }    void Update()
    {
    ...
    {
        Debug.Log("Callback called " + i + ", " + j + ", " + k + ", " + l);
    }
}
```
