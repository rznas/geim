<!-- source: /home/reza/projects/game/docs/UnityDocumentation/Documentation/en/ScriptReference/TransformHandle.TransformVectors.html
...
If you need the inverse operation to transform from world space to local space you can use TransformHandle.InverseTransformVectors

Additional resources:TransformHandle.TransformVector, TransformHandle.InverseTransformVectors, TransformHandle.TransformPoint, TransformHandle.TransformDirection.
