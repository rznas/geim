<!-- source: /home/reza/projects/game/docs/UnityDocumentation/Documentation/en/ScriptReference/Component.GetComponentsInParent.html
...
using UnityEngine;public class GetComponentsInParentExample : MonoBehaviour
{
    public Component[] hingeJoints;    void Start()
    {
        ...
        hingeJoints = GetComponentsInParent<HingeJoint>();        foreach (HingeJoint joint in hingeJoints)
        {
