<!-- source: /home/reza/projects/game/docs/UnityDocumentation/Documentation/en/ScriptReference/TransformHandle.RotateAround.html
...
public class Example : MonoBehaviour
{
    ...
    public GameObject target;    void Update()
    {
        ...
        transformHandle.RotateAround(target.transformHandle.position, Vector3.up, 20 * Time.deltaTime);
    }
}
```
