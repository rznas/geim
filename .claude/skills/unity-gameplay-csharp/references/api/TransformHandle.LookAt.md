<!-- source: /home/reza/projects/game/docs/UnityDocumentation/Documentation/en/ScriptReference/TransformHandle.LookAt.html
...
// continuously point at another object.public class ExampleClass : MonoBehaviour
{
    public TransformHandle target;    void Update()
    {
        ...
        transformHandle.LookAt(target);        // Same as above, but setting the worldUp parameter to Vector3.left in this example turns the camera on its side
        transformHandle.LookAt(target, Vector3.left);
    }
}
```
...
using UnityEngine;public class ExampleClass : MonoBehaviour
{
    void Update()
    {
        ...
        transformHandle.LookAt(Vector3.zero);
    }
}
```
