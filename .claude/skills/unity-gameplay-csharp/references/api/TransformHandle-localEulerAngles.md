<!-- source: /home/reza/projects/game/docs/UnityDocumentation/Documentation/en/ScriptReference/TransformHandle-localEulerAngles.html
...
public class ExampleScript : MonoBehaviour
{
    ...
    float z;    void Update()
    {
        ...
        thisTransformHandle.localEulerAngles = currentEulerAngles;
    }    void OnGUI()
    {
        GUIStyle style = new GUIStyle();
        style.fontSize = 24;
        GUI.Label(new Rect(10, 0, 0, 0), "Rotating on X:" + x + " Y:" + y + " Z:" + z, style);        GUI.Label(new Rect(10, 50, 0, 0), "TransformHandle.localEulerAngle: " + transformHandle.localEulerAngles, style);
    }
}
```

Unity automatically converts the angles to and from the rotation stored in TransformHandle.localRotation.
