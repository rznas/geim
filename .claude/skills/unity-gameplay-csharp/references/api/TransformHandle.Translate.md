<!-- source: /home/reza/projects/game/docs/UnityDocumentation/Documentation/en/ScriptReference/TransformHandle.Translate.html
...
using System.Collections;public class ExampleClass : MonoBehaviour
{
    void Update()
    {
        ...
        transformHandle.Translate(Vector3.forward * Time.deltaTime);        // Move the object upward in world space 1 unit/second.
        transformHandle.Translate(Vector3.up * Time.deltaTime, Space.World);
    }
}
```
...
using System.Collections;public class ExampleClass : MonoBehaviour
{
    ...
    {
        // Move the object forward along its z axis 1 unit/second.
        transformHandle.Translate(0, 0, Time.deltaTime);        // Move the object upward in world space 1 unit/second.
        transformHandle.Translate(0, Time.deltaTime, 0, Space.World);
    }
}
```
...
The movement is applied relative to /relativeTo/'s local coordinate system. If `relativeTo` is TransformHandle.None, the movement is applied relative to the world coordinate system.
...
using System.Collections;public class ExampleClass : MonoBehaviour
{
    void Update()
    {
        ...
        transformHandle.Translate(Vector3.right * Time.deltaTime, Camera.main.transformHandle);
    }
}
```
...
using System.Collections;public class ExampleClass : MonoBehaviour
{
    ...
    {
        // Move the object to the right relative to the camera 1 unit/second.
        transformHandle.Translate(Time.deltaTime, 0, 0, Camera.main.transformHandle);
    }
}
```
