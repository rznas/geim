<!-- source: /home/reza/projects/game/docs/UnityDocumentation/Documentation/en/ScriptReference/TransformHandle.InverseTransformPoints.html
...
This function is essentially the opposite of TransformHandle.TransformPoints which is used to convert from local to world space.
...
Additional resources:TransformHandle.TransformPoints, TransformHandle.InverseTransformPoint, TransformHandle.InverseTransformDirections, TransformHandle.InverseTransformVectors.
...
Note that the returned positions are affected by scale. Use TransformHandle.InverseTransformDirections if you are dealing with direction vectors rather than positions.
