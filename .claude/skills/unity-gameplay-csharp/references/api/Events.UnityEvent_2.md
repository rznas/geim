<!-- source: /home/reza/projects/game/docs/UnityDocumentation/Documentation/en/ScriptReference/Events.UnityEvent_2.html
...
{
    UnityEvent<int, int> m_MyEvent;    void Start()
    {
        if (m_MyEvent == null)
            m_MyEvent = new UnityEvent<int, int>();        m_MyEvent.AddListener(DoSomething);
    }    void Update()
    {
