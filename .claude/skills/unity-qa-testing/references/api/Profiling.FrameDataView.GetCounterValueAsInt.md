<!-- source: /home/reza/projects/game/docs/UnityDocumentation/Documentation/en/ScriptReference/Profiling.FrameDataView.GetCounterValueAsInt.html
...
**int** Returns the counter value as *int*.
...
{
    static unsafe int ExtractMyCounterValue(FrameDataView frameData, string counterName)
    {
