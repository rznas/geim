<!-- source: /home/reza/projects/game/docs/UnityDocumentation/Documentation/en/ScriptReference/Profiling.FrameDataView.GetCounterValueAsLong.html
...
**long** Returns the counter value as *long*.
...
{
    static unsafe long ExtractMyCounterValue(FrameDataView frameData, string counterName)
    {
