<!-- source: /home/reza/projects/game/docs/UnityDocumentation/Documentation/en/Manual/test-framework/course/running-tests-programmatically.html
...
The sample `17_RunningTestsProgrammatically` contains a mono behavior script called `MyMonoBehaviour`, which has a property for whether it has been configured. The project also contains a **scene** with multiple game objects with `MyMonoBehaviour` on them.
