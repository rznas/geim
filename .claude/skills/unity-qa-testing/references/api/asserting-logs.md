<!-- source: /home/reza/projects/game/docs/UnityDocumentation/Documentation/en/Manual/test-framework/course/asserting-logs.html
...
In the sample `5_AssertingLogs` there is a class called `MyLoggingClass`.
