<!-- source: /home/reza/projects/game/docs/UnityDocumentation/Documentation/en/Manual/test-framework/course/scene-based-tests.html
...
API reference for `EditorSceneManager`
