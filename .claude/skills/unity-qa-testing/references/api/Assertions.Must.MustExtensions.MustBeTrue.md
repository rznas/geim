<!-- source: /home/reza/projects/game/docs/UnityDocumentation/Documentation/en/ScriptReference/Assertions.Must.MustExtensions.MustBeTrue.html
...
using UnityEngine.Assertions.Must;public class AssertionExampleClass : MonoBehaviour
{
    void Update()
    {
        ...
        gameObject.activeSelf.MustBeTrue();
    }
}
```
