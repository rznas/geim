<!-- source: /home/reza/projects/game/docs/UnityDocumentation/Documentation/en/Manual/test-framework/course/play-mode-tests.html
...
The sample `7_PlayModeTests` contains an empty project. Import this sample and add a new assembly for Play Mode tests.
