<!-- source: /home/reza/projects/game/docs/UnityDocumentation/Documentation/en/ScriptReference/ProfilerWindow-selectedModuleIdentifier.html
     Unity 6 (6000.x) — converted by unity_html_to_md.py.
     Doc-sourced; not compile-tested in this environment. -->

### Description

The identifier of the Profiler module that is currently selected in the Profiler Window, or null if no Module is currently selected.

The Profiler Window shows the Module Details panel in its bottom half for the currently selected module. Compare this field's value to constants like ProfilerWindow.cpuModuleIdentifier and ProfilerWindow.gpuModuleIdentifier to check which module is currently selected.
