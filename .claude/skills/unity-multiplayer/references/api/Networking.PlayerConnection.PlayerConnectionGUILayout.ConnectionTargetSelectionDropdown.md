<!-- source: /home/reza/projects/game/docs/UnityDocumentation/Documentation/en/ScriptReference/Networking.PlayerConnection.PlayerConnectionGUILayout.ConnectionTargetSelectionDropdown.html
...
| --- | --- |
| state | The state of the connection that the EditorWindow displaying the drop-down uses. Use PlayerConnectionGUIUtility.GetConnectionState to get a state in OnEnable. Make sure you dispose of that state in OnDisable to avoid leaking it. |
...
Also see PlayerConnectionGUI.ConnectionTargetSelectionDropdown for manual positioning as well as PlayerConnectionGUIUtility.GetConnectionState and IConnectionState for details of the state handling for this UI control.
