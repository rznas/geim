<!-- source: /home/reza/projects/game/docs/UnityDocumentation/Documentation/en/ScriptReference/iOS.Xcode.ProjectCapabilityManager.AddGroupActivities.html
...
using UnityEditor.iOS.Xcode;public class Sample_AddGroupActivities  
{
    [PostProcessBuild]
    public static void OnPostprocessBuild(BuildTarget buildTarget, string pathToBuiltProject)
    {
        ...
        }        // Initialize ProjectCapabilityManager and add 'Group Activities' capability
        ...
        capabilityManager.AddGroupActivities();        // Call WriteToFile to save the changes to project file
