<!-- source: /home/reza/projects/game/docs/UnityDocumentation/Documentation/en/ScriptReference/Unity.Android.Gradle.Repositories.html
...
| --- | --- |
| Google | Google reppsitory google(). |
| GradlePluginPortal | GradlePluginPortal reppsitory gradlePluginPortal(). |
| JCenter | JCenter reppsitory jcenter(). |
| Maven | Maven reppsitory maven(). |
| MavenCentral | MavenCentral reppsitory mavenCentral(). |
