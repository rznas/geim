<!-- source: /home/reza/projects/game/docs/UnityDocumentation/Documentation/en/ScriptReference/iOS.Xcode.ProjectCapabilityManager.AddMultipath.html
...
using UnityEditor.iOS.Xcode;public class Sample_AddMultipath  
{
    [PostProcessBuild]
    public static void OnPostprocessBuild(BuildTarget buildTarget, string pathToBuiltProject)
    {
        ...
        }        // Initialize ProjectCapabilityManager and add 'Multipath' capability
        ...
        capabilityManager.AddMultipath();        // Call WriteToFile to save the changes to project file
