<!-- source: /home/reza/projects/game/docs/UnityDocumentation/Documentation/en/ScriptReference/iOS.Xcode.ProjectCapabilityManager.AddExtendedVirtualAddressing.html
...
using UnityEditor.iOS.Xcode;public class Sample_AddExtendedVirtualAddressing  
{
    [PostProcessBuild]
    public static void OnPostprocessBuild(BuildTarget buildTarget, string pathToBuiltProject)
    {
        ...
        }        // Initialize ProjectCapabilityManager and add 'Extended Virtual Addressing' capability
        ...
        capabilityManager.AddExtendedVirtualAddressing();        // Call WriteToFile to save the changes to project file
