<!-- source: /home/reza/projects/game/docs/UnityDocumentation/Documentation/en/ScriptReference/iOS.Xcode.ProjectCapabilityManager.AddMessagesCollaboration.html
...
using UnityEditor.iOS.Xcode;public class Sample_AddMessagesCollaboration  
{
    [PostProcessBuild]
    public static void OnPostprocessBuild(BuildTarget buildTarget, string pathToBuiltProject)
    {
        ...
        }        // Initialize ProjectCapabilityManager and add 'AddMessagesCollaboration' capability
        ...
        capabilityManager.AddMessagesCollaboration();        // Call WriteToFile to save the changes to project file
