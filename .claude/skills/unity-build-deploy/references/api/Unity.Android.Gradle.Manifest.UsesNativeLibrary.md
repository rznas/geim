<!-- source: /home/reza/projects/game/docs/UnityDocumentation/Documentation/en/ScriptReference/Unity.Android.Gradle.Manifest.UsesNativeLibrary.html
     Unity 6 (6000.x) — converted by unity_html_to_md.py.
     Doc-sourced; not compile-tested in this environment. -->

### Description

The C# definition of the `<uses-native-library>` Android Manifest element.

For more information about the element, see Android's documentation: [UsesNativeLibrary element](https://developer.android.com/guide/topics/manifest/uses-native-library-element)

### Properties

| Property | Description |
| --- | --- |
| Attributes | The attributes container for the <uses-native-library> element. |
