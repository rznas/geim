<!-- source: /home/reza/projects/game/docs/UnityDocumentation/Documentation/en/Manual/class-PlayerSettings.html
...
There are some general settings that all platforms share by default, unless you use build profiles.

**Note**: With build profiles, you can customize the Player settings per build profile to set different values for each platform. For more information, refer to Override settings with build profiles.
...
- **Splash Image**: the image shown while the game is launching. This section also includes common settings for creating a Splash Screen. For more information, refer to the Splash Image documentation.
...
- **Embedded Linux:** Embedded Linux Player settings
- **iOS:** iOS Player settings
- **Linux:** Linux Player settings
- **macOS:** macOS Player settings
- **QNX:** QNX Player settings
- **tvOS:** tvOS Player settings
- **Universal Windows Platform:** UWP Player settings
- **Web:** Web Player settings
