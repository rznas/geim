<!-- source: /home/reza/projects/game/docs/UnityDocumentation/Documentation/en/Manual/qnx-build-settings.html
     Unity 6 (6000.x) — converted by unity_html_to_md.py.
     Doc-sourced; not compile-tested in this environment. -->

# QNX build settings reference

Use the QNX build settings to configure and build your application for the QNX platform. The QNX build settings are included in the **Platform Settings** section of the Build Profiles window.
