<!-- source: /home/reza/projects/game/docs/UnityDocumentation/Documentation/en/ScriptReference/iOS.Xcode.ProjectCapabilityManager.AddWirelessAccessoryConfiguration.html
...
using UnityEditor.iOS.Xcode;public class Sample_AddWirelessAccessoryConfiguration  
{
    [PostProcessBuild]
    public static void OnPostprocessBuild(BuildTarget buildTarget, string pathToBuiltProject)
    {
        ...
        }        // Initialize ProjectCapabilityManager and add 'Wireless Accessory Configuration' capability
        ...
        capabilityManager.AddWirelessAccessoryConfiguration();        // Call WriteToFile to save the changes to project file
