<!-- source: /home/reza/projects/game/docs/UnityDocumentation/Documentation/en/ScriptReference/iOS.Xcode.ProjectCapabilityManager.AddShallowDepthAndPressure.html
...
using UnityEditor.iOS.Xcode;public class Sample_AddShallowDepthAndPressure  
{
    [PostProcessBuild]
    public static void OnPostprocessBuild(BuildTarget buildTarget, string pathToBuiltProject)
    {
        ...
        }        // Initialize ProjectCapabilityManager and add 'Shallow Depth And Pressure' capability
        ...
        capabilityManager.AddShallowDepthAndPressure();        // Call WriteToFile to save the changes to project file
