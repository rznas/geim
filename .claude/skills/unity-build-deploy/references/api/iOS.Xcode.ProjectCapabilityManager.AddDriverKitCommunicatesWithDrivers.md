<!-- source: /home/reza/projects/game/docs/UnityDocumentation/Documentation/en/ScriptReference/iOS.Xcode.ProjectCapabilityManager.AddDriverKitCommunicatesWithDrivers.html
...
using UnityEditor.iOS.Xcode;public class Sample_AddDriverKitCommunicatesWithDrivers  
{
    [PostProcessBuild]
    public static void OnPostprocessBuild(BuildTarget buildTarget, string pathToBuiltProject)
    {
        ...
        }        // Initialize ProjectCapabilityManager and add 'DriverKit Communicates With Drivers' capability
        ...
        capabilityManager.AddDriverKitCommunicatesWithDrivers();        // Call WriteToFile to save the changes to project file
