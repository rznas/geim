<!-- source: /home/reza/projects/game/docs/UnityDocumentation/Documentation/en/ScriptReference/iOS.Xcode.ProjectCapabilityManager.AddInterAppAudio.html
...
using UnityEditor.iOS.Xcode;public class Sample_AddInterAppAudio  
{
    [PostProcessBuild]
    public static void OnPostprocessBuild(BuildTarget buildTarget, string pathToBuiltProject)
    {
        ...
        }        // Initialize ProjectCapabilityManager and add 'Inter-App Audio' capability
        ...
        capabilityManager.AddInterAppAudio();        // Call WriteToFile to save the changes to project file
