<!-- source: /home/reza/projects/game/docs/UnityDocumentation/Documentation/en/ScriptReference/Unity.Android.Gradle.Manifest.Intent.html
...
| --- | --- |
| Action | Child element <action>. |
| Attributes | The attributes container for the <intent> element. |
| DataList | List of <data> child elements. |
