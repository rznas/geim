<!-- source: /home/reza/projects/game/docs/UnityDocumentation/Documentation/en/ScriptReference/iOS.Xcode.ProjectCapabilityManager.AddTimeSensitiveNotifications.html
...
using UnityEditor.iOS.Xcode;public class Sample_AddTimeSensitiveNotifications  
{
    [PostProcessBuild]
    public static void OnPostprocessBuild(BuildTarget buildTarget, string pathToBuiltProject)
    {
        ...
        }        // Initialize ProjectCapabilityManager and add 'Time Sensitive Notifications' capability
        ...
        capabilityManager.AddTimeSensitiveNotifications();        // Call WriteToFile to save the changes to project file
