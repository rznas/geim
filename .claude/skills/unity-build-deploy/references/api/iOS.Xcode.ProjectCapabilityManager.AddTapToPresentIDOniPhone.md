<!-- source: /home/reza/projects/game/docs/UnityDocumentation/Documentation/en/ScriptReference/iOS.Xcode.ProjectCapabilityManager.AddTapToPresentIDOniPhone.html
...
using UnityEditor.iOS.Xcode;public class Sample_AddTapToPresentIDOniPhone  
{
    [PostProcessBuild]
    public static void OnPostprocessBuild(BuildTarget buildTarget, string pathToBuiltProject)
    {
        ...
        }        // Initialize ProjectCapabilityManager and add 'Tap To Present ID On iPhone' capability
        ...
        capabilityManager.AddTapToPresentIDOniPhone();        // Call WriteToFile to save the changes to project file
