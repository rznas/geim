<!-- source: /home/reza/projects/game/docs/UnityDocumentation/Documentation/en/ScriptReference/iOS.Xcode.PlistElementDate.html
...
| --- | --- |
| value | The value stored in the date element. |

### Constructors

| Constructor | Description |
| --- | --- |
| PlistElementDate | Creates new date element. |
