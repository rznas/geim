<!-- source: /home/reza/projects/game/docs/UnityDocumentation/Documentation/en/ScriptReference/iOS.Xcode.ProjectCapabilityManager.AddFileProviderTestingMode.html
...
using UnityEditor.iOS.Xcode;public class Sample_AddFileProviderTestingMode  
{
    [PostProcessBuild]
    public static void OnPostprocessBuild(BuildTarget buildTarget, string pathToBuiltProject)
    {
        ...
        }        // Initialize ProjectCapabilityManager and add 'FileProvider Testing Mode' capability
        ...
        capabilityManager.AddFileProviderTestingMode();        // Call WriteToFile to save the changes to project file
