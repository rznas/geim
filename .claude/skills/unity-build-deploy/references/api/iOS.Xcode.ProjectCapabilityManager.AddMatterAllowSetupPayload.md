<!-- source: /home/reza/projects/game/docs/UnityDocumentation/Documentation/en/ScriptReference/iOS.Xcode.ProjectCapabilityManager.AddMatterAllowSetupPayload.html
...
using UnityEditor.iOS.Xcode;public class Sample_AddMatterAllowSetupPayload  
{
    [PostProcessBuild]
    public static void OnPostprocessBuild(BuildTarget buildTarget, string pathToBuiltProject)
    {
        ...
        }        // Initialize ProjectCapabilityManager and add 'Matter Allow Setup Payload' capability
        ...
        capabilityManager.AddMatterAllowSetupPayload();        // Call WriteToFile to save the changes to project file
