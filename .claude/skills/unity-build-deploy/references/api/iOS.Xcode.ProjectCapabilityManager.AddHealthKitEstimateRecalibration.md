<!-- source: /home/reza/projects/game/docs/UnityDocumentation/Documentation/en/ScriptReference/iOS.Xcode.ProjectCapabilityManager.AddHealthKitEstimateRecalibration.html
...
using UnityEditor.iOS.Xcode;public class Sample_AddHealthKitEstimateRecalibration  
{
    [PostProcessBuild]
    public static void OnPostprocessBuild(BuildTarget buildTarget, string pathToBuiltProject)
    {
        ...
        }        // Initialize ProjectCapabilityManager and add 'HealthKit Estimate Recalibration' capability
        ...
        capabilityManager.AddHealthKitEstimateRecalibration();        // Call WriteToFile to save the changes to project file
