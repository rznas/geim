<!-- source: /home/reza/projects/game/docs/UnityDocumentation/Documentation/en/ScriptReference/Unity.Android.Gradle.SigningConfigs.html
     Unity 6 (6000.x) — converted by unity_html_to_md.py.
     Doc-sourced; not compile-tested in this environment. -->

### Description

The C# definition of the `signingConfigs` element in a gradle file. This element is a block and contains `signingConfig` elements.
...
| --- | --- |
| SigningConfigs | Element constructor. |

### Public Methods

| Method | Description |
| --- | --- |
| AddSigningConfig | Adds a signing config by name. |
