<!-- source: /home/reza/projects/game/docs/UnityDocumentation/Documentation/en/ScriptReference/iOS.Xcode.ProjectCapabilityManager.AddFonts.html
...
| --- | --- |
| options | Mask of FontsOptions to enable. |

### Description

Add the Fonts capability.

```csharp
using UnityEditor;
using UnityEditor.Callbacks;
using UnityEditor.iOS.Xcode;public class Sample_AddFonts  
{
    [PostProcessBuild]
    public static void OnPostprocessBuild(BuildTarget buildTarget, string pathToBuiltProject)
    {
        ...
        }        // Initialize ProjectCapabilityManager and add 'Fonts' capability
        ...
        capabilityManager.AddFonts(ProjectCapabilityManager.FontsOptions.None);        // Call WriteToFile to save the changes to project file
