<!-- source: /home/reza/projects/game/docs/UnityDocumentation/Documentation/en/ScriptReference/iOS.Xcode.ProjectCapabilityManager.AddSensitiveContentAnalysis.html
...
using UnityEditor.iOS.Xcode;public class Sample_AddSensitiveContentAnalysis  
{
    [PostProcessBuild]
    public static void OnPostprocessBuild(BuildTarget buildTarget, string pathToBuiltProject)
    {
        ...
        }        // Initialize ProjectCapabilityManager and add 'Sensitive Content Analysis' capability
        ...
        capabilityManager.AddSensitiveContentAnalysis();        // Call WriteToFile to save the changes to project file
