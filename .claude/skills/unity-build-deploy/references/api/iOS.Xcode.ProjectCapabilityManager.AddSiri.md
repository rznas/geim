<!-- source: /home/reza/projects/game/docs/UnityDocumentation/Documentation/en/ScriptReference/iOS.Xcode.ProjectCapabilityManager.AddSiri.html
...
using UnityEditor.iOS.Xcode;public class Sample_AddSiri  
{
    [PostProcessBuild]
    public static void OnPostprocessBuild(BuildTarget buildTarget, string pathToBuiltProject)
    {
        ...
        }        // Initialize ProjectCapabilityManager and add 'Siri' capability
        ...
        capabilityManager.AddSiri();        // Call WriteToFile to save the changes to project file
