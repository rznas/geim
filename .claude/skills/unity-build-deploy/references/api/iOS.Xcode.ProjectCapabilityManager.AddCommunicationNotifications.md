<!-- source: /home/reza/projects/game/docs/UnityDocumentation/Documentation/en/ScriptReference/iOS.Xcode.ProjectCapabilityManager.AddCommunicationNotifications.html
...
using UnityEditor.iOS.Xcode;public class Sample_AddCommunicationNotifications  
{
    [PostProcessBuild]
    public static void OnPostprocessBuild(BuildTarget buildTarget, string pathToBuiltProject)
    {
        ...
        }        // Initialize ProjectCapabilityManager and add 'Communication Notifications' capability
        ...
        capabilityManager.AddCommunicationNotifications();        // Call WriteToFile to save the changes to project file
