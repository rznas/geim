<!-- source: /home/reza/projects/game/docs/UnityDocumentation/Documentation/en/ScriptReference/iOS.Xcode.ProjectCapabilityManager.AddNearFieldCommunication.html
...
using UnityEditor.iOS.Xcode;public class Sample_AddNearFieldCommunication  
{
    [PostProcessBuild]
    public static void OnPostprocessBuild(BuildTarget buildTarget, string pathToBuiltProject)
    {
        ...
        }        // Initialize ProjectCapabilityManager and add 'Near Field Communication (NFC) Tag Reading' capability
        ...
        capabilityManager.AddNearFieldCommunication();        // Call WriteToFile to save the changes to project file
