<!-- source: /home/reza/projects/game/docs/UnityDocumentation/Documentation/en/ScriptReference/iOS.Xcode.PlistElementReal.html
...
| --- | --- |
| value | The value stored in the real element. |

### Constructors

| Constructor | Description |
| --- | --- |
| PlistElementReal | Creates new real element. |
