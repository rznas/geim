<!-- source: /home/reza/projects/game/docs/UnityDocumentation/Documentation/en/ScriptReference/iOS.Xcode.ProjectCapabilityManager.AddFamilyControls.html
...
using UnityEditor.iOS.Xcode;public class Sample_AddFamilyControls  
{
    [PostProcessBuild]
    public static void OnPostprocessBuild(BuildTarget buildTarget, string pathToBuiltProject)
    {
        ...
        }        // Initialize ProjectCapabilityManager and add 'Family Controls' capability
        ...
        capabilityManager.AddFamilyControls();        // Call WriteToFile to save the changes to project file
