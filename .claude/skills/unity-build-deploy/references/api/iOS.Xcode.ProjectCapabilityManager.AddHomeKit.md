<!-- source: /home/reza/projects/game/docs/UnityDocumentation/Documentation/en/ScriptReference/iOS.Xcode.ProjectCapabilityManager.AddHomeKit.html
...
using UnityEditor.iOS.Xcode;public class Sample_AddHomeKit  
{
    [PostProcessBuild]
    public static void OnPostprocessBuild(BuildTarget buildTarget, string pathToBuiltProject)
    {
        ...
        }        // Initialize ProjectCapabilityManager and add 'HomeKit' capability
        ...
        capabilityManager.AddHomeKit();        // Call WriteToFile to save the changes to project file
