<!-- source: /home/reza/projects/game/docs/UnityDocumentation/Documentation/en/ScriptReference/iOS.Xcode.ProjectCapabilityManager.AddSignInWithApple.html
...
using UnityEditor.iOS.Xcode;public class Sample_AddSignInWithApple  
{
    [PostProcessBuild]
    public static void OnPostprocessBuild(BuildTarget buildTarget, string pathToBuiltProject)
    {
        ...
        capabilityManager.AddSignInWithApple();        // Call WriteToFile to save the changes to project file
