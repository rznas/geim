<!-- source: /home/reza/projects/game/docs/UnityDocumentation/Documentation/en/ScriptReference/Unity.Android.Gradle.ApplyPluginList.html
...
| Method | Description |
| --- | --- |
| AddPluginByName | Adds an apply plugin: '{name}' element to the block. |
| AddPluginRaw | Adds an apply plugin: {value} element to the block. |
