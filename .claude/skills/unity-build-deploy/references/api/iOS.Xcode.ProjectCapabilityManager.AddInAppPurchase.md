<!-- source: /home/reza/projects/game/docs/UnityDocumentation/Documentation/en/ScriptReference/iOS.Xcode.ProjectCapabilityManager.AddInAppPurchase.html
...
using UnityEditor.iOS.Xcode;public class Sample_AddInAppPurchase  
{
    [PostProcessBuild]
    public static void OnPostprocessBuild(BuildTarget buildTarget, string pathToBuiltProject)
    {
        ...
        }        // Initialize ProjectCapabilityManager and add 'In-App Purchase' capability
        ...
        capabilityManager.AddInAppPurchase();        // Currently also need to add StoreKit.framework        // Call WriteToFile to save the changes to project file
