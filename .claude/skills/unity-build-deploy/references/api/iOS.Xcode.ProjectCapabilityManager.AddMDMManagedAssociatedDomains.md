<!-- source: /home/reza/projects/game/docs/UnityDocumentation/Documentation/en/ScriptReference/iOS.Xcode.ProjectCapabilityManager.AddMDMManagedAssociatedDomains.html
...
using UnityEditor.iOS.Xcode;public class Sample_AddMDMManagedAssociatedDomains  
{
    [PostProcessBuild]
    public static void OnPostprocessBuild(BuildTarget buildTarget, string pathToBuiltProject)
    {
        ...
        }        // Initialize ProjectCapabilityManager and add 'MDM Managed Associated Domains' capability
        ...
        capabilityManager.AddMDMManagedAssociatedDomains();        // Call WriteToFile to save the changes to project file
