<!-- source: /home/reza/projects/game/docs/UnityDocumentation/Documentation/en/ScriptReference/iOS.Xcode.ProjectCapabilityManager.AddWeatherKit.html
...
using UnityEditor.iOS.Xcode;public class Sample_AddWeatherKit  
{
    [PostProcessBuild]
    public static void OnPostprocessBuild(BuildTarget buildTarget, string pathToBuiltProject)
    {
        ...
        }        // Initialize ProjectCapabilityManager and add 'WeatherKit' capability
        ...
        capabilityManager.AddWeatherKit();        // Call WriteToFile to save the changes to project file
