<!-- source: /home/reza/projects/game/docs/UnityDocumentation/Documentation/en/ScriptReference/iOS.Xcode.ProjectCapabilityManager.AddHealthKit.html
...
using UnityEditor.iOS.Xcode;public class Sample_AddHealthKit  
{
    [PostProcessBuild]
    public static void OnPostprocessBuild(BuildTarget buildTarget, string pathToBuiltProject)
    {
        ...
        }        // Initialize ProjectCapabilityManager and add 'HealthKit' capability
        ...
        capabilityManager.AddHealthKit();        // Call WriteToFile to save the changes to project file
