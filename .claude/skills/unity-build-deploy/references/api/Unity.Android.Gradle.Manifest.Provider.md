<!-- source: /home/reza/projects/game/docs/UnityDocumentation/Documentation/en/ScriptReference/Unity.Android.Gradle.Manifest.Provider.html
...
| --- | --- |
| Attributes | The attributes container for the <provider> element. |
| GrantUriPermissionList | List of <grant-uri-permission> child elements. |
| IntentFilterList | List of <intent-filter> child elements. |
| MetaDataList | List of <meta-data> child elements. |
| PathPermissionList | List of <path-permission> child elements. |
