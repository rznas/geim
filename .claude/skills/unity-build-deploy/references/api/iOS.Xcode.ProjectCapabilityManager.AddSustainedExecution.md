<!-- source: /home/reza/projects/game/docs/UnityDocumentation/Documentation/en/ScriptReference/iOS.Xcode.ProjectCapabilityManager.AddSustainedExecution.html
...
using UnityEditor.iOS.Xcode;public class Sample_AddSustainedExecution  
{
    [PostProcessBuild]
    public static void OnPostprocessBuild(BuildTarget buildTarget, string pathToBuiltProject)
    {
        ...
        }        // Initialize ProjectCapabilityManager and add the 'Sustained Execution' capability
        ...
        capabilityManager.AddSustainedExecution();        // Call WriteToFile to save the changes to project file
