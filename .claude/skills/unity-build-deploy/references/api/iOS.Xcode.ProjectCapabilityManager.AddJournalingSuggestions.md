<!-- source: /home/reza/projects/game/docs/UnityDocumentation/Documentation/en/ScriptReference/iOS.Xcode.ProjectCapabilityManager.AddJournalingSuggestions.html
...
using UnityEditor.iOS.Xcode;public class Sample_AddJournalingSuggestions  
{
    [PostProcessBuild]
    public static void OnPostprocessBuild(BuildTarget buildTarget, string pathToBuiltProject)
    {
        ...
        }        // Initialize ProjectCapabilityManager and add 'Journaling Suggestions' capability
        ...
        capabilityManager.AddJournalingSuggestions();        // Call WriteToFile to save the changes to project file
