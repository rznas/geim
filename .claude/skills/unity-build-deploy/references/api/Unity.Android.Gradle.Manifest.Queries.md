<!-- source: /home/reza/projects/game/docs/UnityDocumentation/Documentation/en/ScriptReference/Unity.Android.Gradle.Manifest.Queries.html
...
| --- | --- |
| Attributes | The attributes container for the <queries> element. |
| IntentList | List of <intent> child elements. |
| PackageList | List of <package> child elements. |
