<!-- source: /home/reza/projects/game/docs/UnityDocumentation/Documentation/en/ScriptReference/iOS.Xcode.ProjectCapabilityManager.AddIncreasedMemoryLimit.html
...
using UnityEditor.iOS.Xcode;public class Sample_AddIncreasedMemoryLimit  
{
    [PostProcessBuild]
    public static void OnPostprocessBuild(BuildTarget buildTarget, string pathToBuiltProject)
    {
        ...
        }        // Initialize ProjectCapabilityManager and add 'Increased Memory Limit' capability
        ...
        capabilityManager.AddIncreasedMemoryLimit();        // Call WriteToFile to save the changes to project file
