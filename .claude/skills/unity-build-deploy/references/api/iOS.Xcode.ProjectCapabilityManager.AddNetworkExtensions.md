<!-- source: /home/reza/projects/game/docs/UnityDocumentation/Documentation/en/ScriptReference/iOS.Xcode.ProjectCapabilityManager.AddNetworkExtensions.html
...
| --- | --- |
| options | Mask of NetworkExtensionsOptions to enable. |
...
using UnityEditor.iOS.Xcode;public class Sample_AddNetworkExtensions  
{
    [PostProcessBuild]
    public static void OnPostprocessBuild(BuildTarget buildTarget, string pathToBuiltProject)
    {
        ...
        }        // Initialize ProjectCapabilityManager and add 'Network Extensions' capability
        // Add additional NetworkExtensionsOptions as required
        ...
        capabilityManager.AddNetworkExtensions(ProjectCapabilityManager.NetworkExtensionsOptions.AppProxy | ProjectCapabilityManager.NetworkExtensionsOptions.ContentFilter);        // Call WriteToFile to save the changes to project file
