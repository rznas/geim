<!-- source: /home/reza/projects/game/docs/UnityDocumentation/Documentation/en/ScriptReference/iOS.Xcode.ProjectCapabilityManager.AddManagedAppInstallationUI.html
...
using UnityEditor.iOS.Xcode;public class Sample_AddManagedAppInstallationUI  
{
    [PostProcessBuild]
    public static void OnPostprocessBuild(BuildTarget buildTarget, string pathToBuiltProject)
    {
        ...
        }        // Initialize ProjectCapabilityManager and add 'Managed App Installation UI' capability
        ...
        capabilityManager.AddManagedAppInstallationUI();        // Call WriteToFile to save the changes to project file
