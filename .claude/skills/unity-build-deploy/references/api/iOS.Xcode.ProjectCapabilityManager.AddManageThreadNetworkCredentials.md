<!-- source: /home/reza/projects/game/docs/UnityDocumentation/Documentation/en/ScriptReference/iOS.Xcode.ProjectCapabilityManager.AddManageThreadNetworkCredentials.html
...
using UnityEditor.iOS.Xcode;public class Sample_AddManageThreadNetworkCredentials  
{
    [PostProcessBuild]
    public static void OnPostprocessBuild(BuildTarget buildTarget, string pathToBuiltProject)
    {
        ...
        }        // Initialize ProjectCapabilityManager and add 'Manage Thread Network Credentials' capability
        ...
        capabilityManager.AddManageThreadNetworkCredentials();        // Call WriteToFile to save the changes to project file
