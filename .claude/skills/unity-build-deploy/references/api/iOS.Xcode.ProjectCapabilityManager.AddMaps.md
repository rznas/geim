<!-- source: /home/reza/projects/game/docs/UnityDocumentation/Documentation/en/ScriptReference/iOS.Xcode.ProjectCapabilityManager.AddMaps.html
...
| --- | --- |
| options | Mask of MapsOptions to enable. |

### Description

Add the Maps capability.

```csharp
using UnityEditor;
using UnityEditor.Callbacks;
using UnityEditor.iOS.Xcode;public class Sample_AddMaps  
{
    [PostProcessBuild]
    public static void OnPostprocessBuild(BuildTarget buildTarget, string pathToBuiltProject)
    {
        ...
        }        // Initialize ProjectCapabilityManager and add 'Maps' capability
        // Add additional MapsOptions as required
        ...
        capabilityManager.AddMaps(MapsOptions.Car | MapsOptions.Bike);        // Call WriteToFile to save the changes to project file
