<!-- source: /home/reza/projects/game/docs/UnityDocumentation/Documentation/en/ScriptReference/AudioType.MOD.html
...
using System.Collections;public class AudioTypeExample : MonoBehaviour
{
    ...
    }    IEnumerator GetAudioClip()
    {
        ...
        string url = "https://www.your-website.com/modsound.mod";        // Stream audio, store it as an audio clip and play it. Make sure it has the MOD audio format. 
        using (UnityWebRequest www = UnityWebRequestMultimedia.GetAudioClip(url, AudioType.MOD))
        {
