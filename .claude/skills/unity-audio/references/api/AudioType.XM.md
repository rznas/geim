<!-- source: /home/reza/projects/game/docs/UnityDocumentation/Documentation/en/ScriptReference/AudioType.XM.html
...
using System.Collections;public class AudioTypeExample : MonoBehaviour
{
    ...
    }    IEnumerator GetAudioClip()
    {
        ...
        string url = "https://www.your-website.com/xmsound.xm";        // Stream audio, store it as an audio clip and play it. Make sure it has the XM audio format. 
        using (UnityWebRequest www = UnityWebRequestMultimedia.GetAudioClip(url, AudioType.XM))
        {
