<!-- source: /home/reza/projects/game/docs/UnityDocumentation/Documentation/en/ScriptReference/LowLevelPhysics2D.PhysicsFixedJoint.html
...
| --- | --- |
| PhysicsFixedJoint | Create a PhysicsFixedJoint from the specified base joint. The provided joint must be a joint type of PhysicsJoint.JointType.FixedJoint. |
...
| Method | Description |
| --- | --- |
| Create | Create a PhysicsFixedJoint in the specified world. |
...
| --- | --- |
| PhysicsFixedJoint | Cast to a PhysicsFixedJoint from the base PhysicsJoint. The provided joint must be a joint type of PhysicsJoint.JointType.FixedJoint. |
