<!-- source: /home/reza/projects/game/docs/UnityDocumentation/Documentation/en/ScriptReference/LowLevelPhysics2D.PhysicsRelativeJoint.html
...
| --- | --- |
| PhysicsRelativeJoint | Create a PhysicsRelativeJoint from the specified base joint. The provided joint must be a joint type of PhysicsJoint.JointType.RelativeJoint. |
...
| Method | Description |
| --- | --- |
| Create | Create a PhysicsRelativeJoint in the specified world. |
...
| PhysicsRelativeJoint | Cast to a PhysicsRelativeJoint from the base PhysicsJoint. The provided joint must be a joint type of PhysicsJoint.JointType.RelativeJoint. |
