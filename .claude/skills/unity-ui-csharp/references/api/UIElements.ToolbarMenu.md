<!-- source: /home/reza/projects/game/docs/UnityDocumentation/Documentation/en/ScriptReference/UIElements.ToolbarMenu.html
...
| popupVariantUssClassName | USS class name of elements of this type, when they are displayed as popup menu. |
...
| --- | --- |
| menu | The menu. |
| variant | The display styles that you can use when creating menus. |
