<!-- source: /home/reza/projects/game/docs/UnityDocumentation/Documentation/en/ScriptReference/UIElements.Image.html
...
| Property | Description |
| --- | --- |
| image | The texture to display in this image. If you assign a Texture or Texture2D, the Image element will resize and show the assigned texture. |
