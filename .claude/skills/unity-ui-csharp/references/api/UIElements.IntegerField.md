<!-- source: /home/reza/projects/game/docs/UnityDocumentation/Documentation/en/ScriptReference/UIElements.IntegerField.html
...
| Method | Description |
| --- | --- |
| StringToValue | Converts a string to an integer. |
| ValueToString | Converts the given integer to a string. |
