<!-- source: /home/reza/projects/game/docs/UnityDocumentation/Documentation/en/ScriptReference/EditorGUI.BeginProperty.html
...
class Example : MonoBehaviour
{
    ...
    {
        label = EditorGUI.BeginProperty(position, label, property);        EditorGUI.BeginChangeCheck();
...
Additional resources: EndProperty.
