<!-- source: /home/reza/projects/game/docs/UnityDocumentation/Documentation/en/ScriptReference/UIElements.DoubleField.html
...
| Method | Description |
| --- | --- |
| StringToValue | Converts a string to a double. |
| ValueToString | Converts the given double to a string. |
