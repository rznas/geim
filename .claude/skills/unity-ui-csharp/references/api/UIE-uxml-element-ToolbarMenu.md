<!-- source: /home/reza/projects/game/docs/UnityDocumentation/Documentation/en/Manual/UIE-uxml-element-ToolbarMenu.html
     Unity 6 (6000.x) — converted by unity_html_to_md.py.
     Doc-sourced; not compile-tested in this environment. -->

# ToolbarMenu

A ToolbarMenu is an Editor-only control that serves as a menu. It has a predefined style that matches the Toolbar style.
