<!-- source: /home/reza/projects/game/docs/UnityDocumentation/Documentation/en/Manual/UIE-uxml-element-ToolbarBreadcrumbs.html
     Unity 6 (6000.x) — converted by unity_html_to_md.py.
     Doc-sourced; not compile-tested in this environment. -->

# ToolbarBreadcrumbs

A ToolbarBreadcrumbs is an Editor-only control that serves as a breadcrumb navigation bar. It has a predefined style that matches the Toolbar style.
