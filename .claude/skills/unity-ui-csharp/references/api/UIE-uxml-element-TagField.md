<!-- source: /home/reza/projects/game/docs/UnityDocumentation/Documentation/en/Manual/UIE-uxml-element-TagField.html
     Unity 6 (6000.x) — converted by unity_html_to_md.py.
     Doc-sourced; not compile-tested in this environment. -->

# TagField

The TagField is an Editor-only control that lets users select a tag from a list of tags. It is commonly used in the **Inspector** window to allow users to select a tag for a **GameObject**.
...
The following USS example styles the TagField:
