<!-- source: /home/reza/projects/game/docs/UnityDocumentation/Documentation/en/ScriptReference/Handles.ArrowHandleCap.html
...
```csharp
using UnityEngine;public class ArrowExample : MonoBehaviour {}
```
...
```csharp
using UnityEditor;
using UnityEngine;[CustomEditor(typeof(ArrowExample))]
public class ArrowExampleEditor : Editor
{
    float size = 1f;    protected virtual void OnSceneGUI()
    {
        ...
        {
            Transform transform = ((ArrowExample)target).transform;
