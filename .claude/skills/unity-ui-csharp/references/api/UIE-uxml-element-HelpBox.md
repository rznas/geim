<!-- source: /home/reza/projects/game/docs/UnityDocumentation/Documentation/en/Manual/UIE-uxml-element-HelpBox.html
...
The following USS example styles the HelpBox:

```
.some-styled-help-box {
    height: 100px;
}

.some-styled-help-box .unity-help-box__label {
...
| --- | --- | --- |
| `message-type` | `UIElements.HelpBoxMessageType` | The type of message. |
