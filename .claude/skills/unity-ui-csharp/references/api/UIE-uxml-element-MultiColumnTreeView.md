<!-- source: /home/reza/projects/game/docs/UnityDocumentation/Documentation/en/Manual/UIE-uxml-element-MultiColumnTreeView.html
...
You can bind the `MultiColumnTreeView` to a data source, and automatically populate the rows and columns based on the provided data. Refer to Create list and tree views for an example.
...
The following UXML example creates a MultiColumnTreeView:
...
The following USS example styles the MultiColumnTreeView:
...
The following C# example illustrates some of the customizable functionalities of the MultiColumnTreeView:
