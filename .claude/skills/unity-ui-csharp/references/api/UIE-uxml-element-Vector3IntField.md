<!-- source: /home/reza/projects/game/docs/UnityDocumentation/Documentation/en/Manual/UIE-uxml-element-Vector3IntField.html
...
**Note**: To align a Vector3IntField with other fields in an **Inspector** window, simply apply the `.unity-base-field__aligned` USS class to it. For more information, refer to `BaseField`.
...
The following USS example styles the Vector3IntField:
