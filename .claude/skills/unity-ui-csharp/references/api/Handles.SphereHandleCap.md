<!-- source: /home/reza/projects/game/docs/UnityDocumentation/Documentation/en/ScriptReference/Handles.SphereHandleCap.html
...
```csharp
using UnityEngine;public class SphereExample : MonoBehaviour {}
```
...
```csharp
using UnityEditor;
using UnityEngine;[CustomEditor(typeof(SphereExample))]
