<!-- source: /home/reza/projects/game/docs/UnityDocumentation/Documentation/en/Manual/UIE-uxml-element-RectIntField.html
     Unity 6 (6000.x) — converted by unity_html_to_md.py.
     Doc-sourced; not compile-tested in this environment. -->

# RectIntField

The RectIntField lets users enter a RectInt value in a UI.
...
The following USS example styles the RectIntField:
