<!-- source: /home/reza/projects/game/docs/UnityDocumentation/Documentation/en/Manual/UIE-uxml-element-BoundsIntField.html
     Unity 6 (6000.x) — converted by unity_html_to_md.py.
     Doc-sourced; not compile-tested in this environment. -->

# BoundsIntField

The BoundsIntField lets users enter a BoundsInt value in a UI.
...
The following USS example styles the BoundsIntField:
