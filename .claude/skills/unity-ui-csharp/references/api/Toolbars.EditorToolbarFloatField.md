<!-- source: /home/reza/projects/game/docs/UnityDocumentation/Documentation/en/ScriptReference/Toolbars.EditorToolbarFloatField.html
...
| --- | --- |
| EditorToolbarFloatField | Creates a float field visual element that is styled to match a toolbar in an UnityEditor.Overlays.Overlay. |
...
| supportExpressions | Indicates whether the field supports expressions that can be evaluated into a value. |
