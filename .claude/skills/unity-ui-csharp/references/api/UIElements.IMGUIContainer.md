<!-- source: /home/reza/projects/game/docs/UnityDocumentation/Documentation/en/ScriptReference/UIElements.IMGUIContainer.html
     Unity 6 (6000.x) — converted by unity_html_to_md.py.
     Doc-sourced; not compile-tested in this environment. -->

### Description

Element that draws IMGUI content in the editor. For more information, refer to UXML element IMGUIContainer.
...
| cullingEnabled | When this property is set to true, onGUIHandler is not called when the Element is outside the viewport. |
