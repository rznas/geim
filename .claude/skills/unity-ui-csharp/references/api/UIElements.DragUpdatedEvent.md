<!-- source: /home/reza/projects/game/docs/UnityDocumentation/Documentation/en/ScriptReference/UIElements.DragUpdatedEvent.html
...
| --- | --- |
| DragUpdatedEvent | Constructor. Use GetPooled() to get an event from a pool of reusable events. |
