<!-- source: /home/reza/projects/game/docs/UnityDocumentation/Documentation/en/ScriptReference/UIElements.UnsignedLongField.html
...
| Method | Description |
| --- | --- |
| StringToValue | Converts a string to a unsigned long integer. |
| ValueToString | Converts the given unsigned long integer to a string. |
