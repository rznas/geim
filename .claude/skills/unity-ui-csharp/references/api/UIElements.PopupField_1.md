<!-- source: /home/reza/projects/game/docs/UnityDocumentation/Documentation/en/ScriptReference/UIElements.PopupField_1.html
...
using UnityEngine.UIElements;public class MyData
{
    public string name;
    public int id;
}public class MyPopupField : PopupField<MyData>
{
    public MyPopupField()
    {
        ...
        };        index = 0;        formatSelectedValueCallback = FormatItem;
...
| --- | --- |
| PopupField_1 | Construct a PopupField. |
