<!-- source: /home/reza/projects/game/docs/UnityDocumentation/Documentation/en/Manual/UIE-uxml-element-GradientField.html
     Unity 6 (6000.x) — converted by unity_html_to_md.py.
     Doc-sourced; not compile-tested in this environment. -->

# GradientField

The GradientField is an Editor-only control that lets users set a color gradient from a Gradient Editor.
...
The following USS example styles the GradientField:
