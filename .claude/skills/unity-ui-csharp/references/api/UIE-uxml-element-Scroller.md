<!-- source: /home/reza/projects/game/docs/UnityDocumentation/Documentation/en/Manual/UIE-uxml-element-Scroller.html
...
The following USS example styles the Scroller:

```
.some-styled-scroller {
    height: 100px;
}
```
