<!-- source: /home/reza/projects/game/docs/UnityDocumentation/Documentation/en/Manual/UIE-uxml-element-RadioButtonGroup.html
     Unity 6 (6000.x) — converted by unity_html_to_md.py.
     Doc-sourced; not compile-tested in this environment. -->

# RadioButtonGroup

A RadioButtonGroup offers a single selection out of a logical group of radio buttons. Selecting one cancels the others. RadioButtonGroup is similar to a DropdownField except that it exposes all choices in the UI.
...
The following USS example styles the RadioButtonGroup:
