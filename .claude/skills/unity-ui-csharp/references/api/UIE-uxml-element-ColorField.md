<!-- source: /home/reza/projects/game/docs/UnityDocumentation/Documentation/en/Manual/UIE-uxml-element-ColorField.html
     Unity 6 (6000.x) — converted by unity_html_to_md.py.
     Doc-sourced; not compile-tested in this environment. -->

# ColorField

A ColorField is an Editor-only control that lets users select a color from a color picker. It supports alpha channel and HDR colors. An alpha channel is an extra channel to represent the transparency level of a color. **HDR** colors are high-dynamic range colors that can represent a wider range of colors than standard colors.
...
The following USS example styles the ColorField:
