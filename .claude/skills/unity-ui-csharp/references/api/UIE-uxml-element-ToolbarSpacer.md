<!-- source: /home/reza/projects/game/docs/UnityDocumentation/Documentation/en/Manual/UIE-uxml-element-ToolbarSpacer.html
     Unity 6 (6000.x) — converted by unity_html_to_md.py.
     Doc-sourced; not compile-tested in this environment. -->

# ToolbarSpacer

A ToolbarSpacer is an Editor-only control that creates empty spaces within a Toolbar for layout control and visual separation of elements. It’s a VisualElement with a predefined style that matches the Toolbar style.
