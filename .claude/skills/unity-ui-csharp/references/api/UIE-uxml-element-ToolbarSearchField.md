<!-- source: /home/reza/projects/game/docs/UnityDocumentation/Documentation/en/Manual/UIE-uxml-element-ToolbarSearchField.html
     Unity 6 (6000.x) — converted by unity_html_to_md.py.
     Doc-sourced; not compile-tested in this environment. -->

# ToolbarSearchField

A ToolbarSearchField is an Editor-only control that serves as a search field. It’s a TextField with predefined styles that matches the Toolbar style.
...
**C# class**: `ToolbarSearchField`
 **Namespace**: `UnityEditor.UIElements`
 **Base class**: `SearchFieldBase_2`
