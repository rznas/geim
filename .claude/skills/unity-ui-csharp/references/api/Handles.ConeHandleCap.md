<!-- source: /home/reza/projects/game/docs/UnityDocumentation/Documentation/en/ScriptReference/Handles.ConeHandleCap.html
...
```csharp
using UnityEditor;
using UnityEngine;[CustomEditor(typeof(ConeExample))]
public class ConeExampleEditor : Editor
{
    float size = 1f;    protected virtual void OnSceneGUI()
    {
        if (Event.current.type == EventType.Repaint)
        {
            Transform transform = ((ConeExample)target).transform;
