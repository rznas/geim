<!-- source: /home/reza/projects/game/docs/UnityDocumentation/Documentation/en/ScriptReference/GUILayout.BeginHorizontal.html
...
using UnityEngine;public class ExampleScript : MonoBehaviour
{
    void OnGUI()
    {
        ...
        GUILayout.Button("I'm to the right");        GUILayout.EndHorizontal();
    }
}
```
