<!-- source: /home/reza/projects/game/docs/UnityDocumentation/Documentation/en/ScriptReference/UIElements.PointerUpEvent.html
...
The last pressed button may or may not be the same button that triggered the PointerDownEvent.
 ...
 See PointerEventBase<T0> to see how PointerUpEvent relates to other pointer events.
