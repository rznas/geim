<!-- source: /home/reza/projects/game/docs/UnityDocumentation/Documentation/en/Manual/UIE-uxml-element-Mask64Field.html
     Unity 6 (6000.x) — converted by unity_html_to_md.py.
     Doc-sourced; not compile-tested in this environment. -->

# Mask64Field

The Mask64Field is an Editor-only control that lets users select one or more options from a list of options.

The difference between Mask64Field and MaskField is that Mask64Field supports a 64-bit bitmask while MarkField supports a 32-bit bitmask.
...
The following USS example styles the Mask64Field:
