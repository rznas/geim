<!-- source: /home/reza/projects/game/docs/UnityDocumentation/Documentation/en/Manual/UIE-uxml-element-ToolbarButton.html
     Unity 6 (6000.x) — converted by unity_html_to_md.py.
     Doc-sourced; not compile-tested in this environment. -->

# ToolbarButton

A ToolbarButton is an Editor-only control that serves as a button in a Toolbar. It’s a Button with a predefined style that matches the Toolbar style.
