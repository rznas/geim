<!-- source: /home/reza/projects/game/docs/UnityDocumentation/Documentation/en/ScriptReference/UIElements.ProgressBar.html
...
public ProgressBar CreateProgressBar()
 {
     ...
     }).Every(75).Until(() => progressBar.value >= 100f);     return progressBar;
 }
```
...
| value | Sets the progress value. The value is clamped between lowValue and highValue. |
