<!-- source: /home/reza/projects/game/docs/UnityDocumentation/Documentation/en/ScriptReference/UIElements.BaseMask64Field.html
...
The difference between Mask64Field and UIElements.MarkField is that Mask64Field supports a 64-bit bitmask while UIElements.MarkField supports a 32-bit bitmask. For more information, refer to UXML element Mask64Field.
...
| choicesMasks | The list of list of masks for every specific choice to display in the popup menu. |
