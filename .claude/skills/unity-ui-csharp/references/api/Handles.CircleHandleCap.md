<!-- source: /home/reza/projects/game/docs/UnityDocumentation/Documentation/en/ScriptReference/Handles.CircleHandleCap.html
...
```csharp
using UnityEngine;public class CircleExample : MonoBehaviour {}
```
...
```csharp
using UnityEditor;
using UnityEngine;[CustomEditor(typeof(CircleExample))]
