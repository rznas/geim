<!-- source: /home/reza/projects/game/docs/UnityDocumentation/Documentation/en/ScriptReference/Search.SearchProvider-id.html
...
static class SearchProvider_id
{
    ...
    {
        var context = SearchService.CreateContext(SearchService.GetProvider(id));
