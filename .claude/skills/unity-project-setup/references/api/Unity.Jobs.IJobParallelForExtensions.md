<!-- source: /home/reza/projects/game/docs/UnityDocumentation/Documentation/en/ScriptReference/Unity.Jobs.IJobParallelForExtensions.html
...
| Schedule | Schedules the job to execute concurrently on multiple worker threads. |
| ScheduleByRef | Schedules the job to execute concurrently, distributing work across multiple worker threads. |
