<!-- source: /home/reza/projects/game/docs/UnityDocumentation/Documentation/en/ScriptReference/SceneView.AddOverlayToActiveView.html
...
See also SceneView.RemoveOverlayFromActiveView.
...
using UnityEngine;
using UnityEngine.UIElements;// An EditorTool that shows an Overlay in the active scene view while enabled.
[EditorTool("Overlay Tool Example", typeof(Transform))]
class ToolWithOverlay : EditorTool
{
    ActiveSceneViewOverlay m_Overlay;    void OnEnable()
    {
...
class ActiveSceneViewOverlay : Overlay
{
    ...
    Transform[] m_Selection;    public ActiveSceneViewOverlay(Transform[] selection)
    {
