<!-- source: /home/reza/projects/game/docs/UnityDocumentation/Documentation/en/ScriptReference/Experimental.GraphView.Resizer.html
...
| --- | --- |
| activateButton | Mouse button to activate the resizer. |

### Constructors

| Constructor | Description |
| --- | --- |
| Resizer | Resizer's constructor. |
