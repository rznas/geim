<!-- source: /home/reza/projects/game/docs/UnityDocumentation/Documentation/en/ScriptReference/GUISkin-verticalScrollbarDownButton.html
...
using UnityEngine;public class Example : MonoBehaviour
{
    ...
    // down button of the current GUISkin    float hSbarValue;
