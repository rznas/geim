<!-- source: /home/reza/projects/game/docs/UnityDocumentation/Documentation/en/ScriptReference/Texture3D.GetPixelData.html
...
using UnityEngine;public class ExampleScript : MonoBehaviour
{
    ...
    {
        // Create a 3D texture
        var m_Texture3D = new Texture3D(16, 16, 16, TextureFormat.RGBA32, true);        // Use GetPixelData to get an array that points to mipmap level 1
        var mip1Data = m_Texture3D.GetPixelData<Color32>(1);        // Fill pixels in mipmap level 1 with white
