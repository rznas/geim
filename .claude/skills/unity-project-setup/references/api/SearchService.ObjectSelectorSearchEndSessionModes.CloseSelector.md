<!-- source: /home/reza/projects/game/docs/UnityDocumentation/Documentation/en/ScriptReference/SearchService.ObjectSelectorSearchEndSessionModes.CloseSelector.html
     Unity 6 (6000.x) — converted by unity_html_to_md.py.
     Doc-sourced; not compile-tested in this environment. -->

### Description

The session is ending because the current object selector needs to be closed.

Here is an example of an object selector engine using CloseSelector to close the currently opened selector:
