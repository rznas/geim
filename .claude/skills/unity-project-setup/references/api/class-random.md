<!-- source: /home/reza/projects/game/docs/UnityDocumentation/Documentation/en/Manual/class-random.html
...
`Random.onUnitCircle` returns a randomly selected point on the circumference of a circle with a radius of 1.
