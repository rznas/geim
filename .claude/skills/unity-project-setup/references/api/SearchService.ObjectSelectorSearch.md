<!-- source: /home/reza/projects/game/docs/UnityDocumentation/Documentation/en/ScriptReference/SearchService.ObjectSelectorSearch.html
...
| --- | --- |
| EngineScope | A enum that indicates the search scope of ObjectSelectorSearch engines. Used by ObjectSelectorSearchContext. |

### Static Methods

| Method | Description |
| --- | --- |
| RegisterEngine | Registers an ObjectSelector search engine dynamically. |
