<!-- source: /home/reza/projects/game/docs/UnityDocumentation/Documentation/en/ScriptReference/Experimental.GraphView.TokenNode.html
...
| --- | --- |
| TokenNode | Constructs a TokenNode with both input and output Ports. |
