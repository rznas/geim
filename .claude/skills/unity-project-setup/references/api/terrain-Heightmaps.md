<!-- source: /home/reza/projects/game/docs/UnityDocumentation/Documentation/en/Manual/terrain-Heightmaps.html
     Unity 6 (6000.x) — converted by unity_html_to_md.py.
     Doc-sourced; not compile-tested in this environment. -->

# Working with Heightmaps

Terrain tools that affect height, such as Raise or Lower Terrain and Set the height of an area or tile, use a grayscale texture called a heightmap. Unity represents the height of each point on the **Terrain** as a value in a rectangular array. It represents this array using a grayscale heightmap. Heightmaps are built into the Terrain, and the values stored in a heightmap define the height of each point or vertex on the Terrain.
