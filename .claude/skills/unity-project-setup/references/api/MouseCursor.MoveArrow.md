<!-- source: /home/reza/projects/game/docs/UnityDocumentation/Documentation/en/ScriptReference/MouseCursor.MoveArrow.html
...
using UnityEditor;public class MouseCursorExample : EditorWindow
{
    ...
    }    void OnGUI()
    {
        ...
        EditorGUIUtility.AddCursorRect(new Rect(20, 20, 140, 40), MouseCursor.MoveArrow);
    }
}
```
