<!-- source: /home/reza/projects/game/docs/UnityDocumentation/Documentation/en/ScriptReference/BuoyancyEffector2D.html
...
| --- | --- |
| angularDamping | A force applied to slow angular movement of any Collider2D in contact with the effector. |
...
| linearDamping | A force applied to slow linear movement of any Collider2D in contact with the effector. |
