<!-- source: /home/reza/projects/game/docs/UnityDocumentation/Documentation/en/ScriptReference/GUISkin-verticalScrollbarUpButton.html
...
using UnityEngine;public class Example : MonoBehaviour
{
    ...
    // up button of the current GUISkin    float hSbarValue;
