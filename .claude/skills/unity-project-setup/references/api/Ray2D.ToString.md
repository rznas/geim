<!-- source: /home/reza/projects/game/docs/UnityDocumentation/Documentation/en/ScriptReference/Ray2D.ToString.html
...
using UnityEngine;public class Example : MonoBehaviour
{
    void Start()
    {
        Ray2D ray = new Ray2D(Vector2.zero, Vector2.zero);
        Debug.Log(ray.ToString()); // output displayed as: "Origin: (0.00, 0.00), Dir: (0.00, 0.00)"
    }
}
```
