<!-- source: /home/reza/projects/game/docs/UnityDocumentation/Documentation/en/ScriptReference/BoundsInt.SetMinMax.html
...
Use this function to set both the minimum and maximum value of the BoundsInt at the same time, faster than setting the values separately.
...
The position and size of the BoundsInt is then adjusted based on the final resolved minimum and maximum values.
