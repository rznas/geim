<!-- source: /home/reza/projects/game/docs/UnityDocumentation/Documentation/en/ScriptReference/Pool.HashSetPool_1.html
...
using UnityEngine.Pool;public class Example
{
    void GetPooled()
    {
        ...
        var instance = HashSetPool<int>.Get();        // Use the HashSet        // Return it back to the pool
