<!-- source: /home/reza/projects/game/docs/UnityDocumentation/Documentation/en/Manual/DefaultPresetsByFolder.html
...
- If there are no presets in parent folders, apply the default preset configured in the Preset Manager window.
